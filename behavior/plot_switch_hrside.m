function plot_switch_hrside(input,tlabel, cmap)
% % plot_switch_hrside %
...
plot(n,probh,'.-','MarkerSize',30,'Linewidth',3,'Color',cmap(1,:));
plot(n,probl,'.-','MarkerSize',30,'Linewidth',3,'Color',cmap(2,:));
...
if numel(input)>1
    for l=1:numel(n)
        ...
        plot(n(l)*[1 1],probl(l)+probl_sem(l)*[-1 1],'-','LineWidth',3,'Color',cmap(2,:));
