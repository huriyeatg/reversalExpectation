function output=choice_switch_hrside_random_opto(stats,trials_back,L1_ranges,L2_ranges)
...
for i=1:numel(stats.blockLength)-1
    ...
    if ~isnan(idx) & stats.selectedBlocks(i)==1 %NaN could arise if we are using merge_session
