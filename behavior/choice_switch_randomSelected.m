function output=choice_switch_randomSelected(stats,trials_back,L1_ranges,L2_ranges)
...
if numruletrans==0 % No switch occured
    ...
    for i=1:numel(stats.blockLength)-1
        ...
        if ~isnan(idx) && stats.blockSt(i)==1  %NaN could arise if we are using merge_session
