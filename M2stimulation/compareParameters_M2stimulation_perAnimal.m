function compareParameters_M2stimulation_perAnimal(simPath)
...
dat(1).input = load(fullfile(simPath.model_mat_M2stimulationPre,'belief_CK_stimulation_bilateral_delta_10params.mat'));
%dat(1).input = load('belief_CK_stimulation_bilateral_delta_10params.mat');
dat(1).label = 'PreStimulation';
dat(1).color = [ 0 0 0];
dat(2).input = load(fullfile(simPath.model_mat_M2stimulationPost,'belief_CK_stimulation_bilateral_delta_10params.mat'));
%dat(2).input = load('belief_CK_stimulation_bilateral_delta_10params.mat');
