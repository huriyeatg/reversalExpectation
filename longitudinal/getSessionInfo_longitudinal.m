function [sessionAfterTraining, sessioninPhase3 ] = getSessionInfo_longitudinal( animal, logfilepath)
% getSessionInfo_longitudinal %
% PURPOSE : calculates the the order of the each session 
