...
if numel(trialData.outcomeTimes) ~= numel(trialData.cueTimes) || ...
    ...
    % 19102: Sometimes the occurrence of a cue is not reported by the NBS
...
if trialData.presCodeSet ==21 || trialData.presCodeSet ==22
...
% Stimulation - region
stimRegionCodes = [1000;1001;1002]; %stimulation code
