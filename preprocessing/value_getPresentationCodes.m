...
if presCodeSet == 3 || presCodeSet == 8  || presCodeSet ==1   || presCodeSet ==2
...
elseif presCodeSet == 21 || presCodeSet == 22
    %% Reversal + OptoLaser for Cg1/M2 only
    ...
    EVENT.LASERON      = 63;
    EVENT.LASEROFF     = 62;
    EVENT.Site_cntrl       = 1000;
    EVENT.Site_rightM2     = 1001;
    EVENT.Site_leftM2      = 1002;
...
elseif presCodeSet == 31  || presCodeSet == 32
